...
cousin_rule = IF( AND('parent (?x) (?z)', 'parent (?y) (?a)', 'sibling (?x) (?y)'),
...
# family_rules.
family_rules = [ same_identity_rule, brother_sister_rule, brother_brother_rule, sister_sister_rule, father_rule, mother_rule, son_rule, daughter_rule,
cousin_rule, grandparent_rule]                    # fill me in
